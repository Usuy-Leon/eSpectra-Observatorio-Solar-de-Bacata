...
\captionof{figure}{ Pictogramas de la sabana de Cundinamarca (facatativa): Las formas representadas corresponden a diseños de manos, soles y formas zoomorfas, especialmente raniformes. Adaptado de \cite{saenz_cepeda_2020}} 
\justifying
...
\captionof{figure}{ Linea de tiempo construccion de lugares historicos del centro de Bogota. }
...
\centering
   \includegraphics[width=0.51\textwidth]{images/Triangles.png}
   \includegraphics[width=0.45\textwidth]{images/triangles_with_arcs.png}
\captionof{figure}{ Representacion 3D y 2D de los triangulos de alineaciones solares y su disismilitud y similitud con respecto al triangulo de observacion ideal. }
